...
# BibTeX
```bibtex
@article{tonderski2022future,
  title   = {Future Object Detection with Spatiotemporal Transformers},
  author  = {Tonderski, Adam and Johnander, Joakim and Petersson, Christoffer and Åström, Kalle},
  journal = {arXiv preprint arXiv:2204.10321},
  year    = {2022}
}
```