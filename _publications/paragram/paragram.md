...
arxiv: https://arxiv.org/abs/2605.06408
...
A GPU algorithm that constructs 3D Voronoi and power diagrams for tens of millions of points under arbitrary spatial distributions.
As a drop-in replacement in mesh-based neural rendering, it scales explicit volumetric representations to over 20 million sites, directly translating to improved reconstruction quality.
</p>
</div>
